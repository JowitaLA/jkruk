    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
            <div class="col-lg-5 mb-4" data-aos="fade-right" data-aos-delay="100">
                <img class="img-fluid custom-img mb-4" src="{{ asset('public/assets/img/photo.jpg') }}" alt="..." />
            </div>
...
<section class="projects-section" id="projects">
        ...
        <div class="carousel-inner">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center m-4">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <img class="img-fluid-border mb-3 mb-lg-0"
                            src="{{ asset ('public/assets/img/webs/Monwiz.png') }}" alt="Monwiz" />
                    </div>
            ...
            <div class="carousel-item" data-bs-interval="5000">
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center m-4">
                    <div class="col-xl-1 col-lg-1"></div>
                    <div class="col-xl-5 col-lg-5">
                        <img class="img-fluid-border mb-3 mb-lg-0" src="{{ asset ('public/assets/img/webs/Yups.png') }}"
                            alt="Yups" />
                    </div>
                    <div class="col-xl-5 col-lg-5 d-flex flex-column">
                        <div class="featured-text text-center">
            ...
            <div class="carousel-item" data-bs-interval="5000">
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center m-4">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <img class="img-fluid-border mb-3 mb-lg-0"
                            src="{{ asset ('public/assets/img/webs/PlayHunt.png') }}" alt="PlayHunt" />
                    </div>
                    <div class="col-xl-5 col-lg-5 d-flex flex-column">
                        <div class="featured-text text-center">
            ...
            <div class="carousel-item" data-bs-interval="5000">
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center m-4">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <img class="img-fluid-border mb-3 mb-lg-0"
                            src="{{ asset ('public/assets/img/webs/Quizow.png') }}" alt="Quizow" />
                    </div>
                    <div class="col-xl-5 col-lg-5 d-flex flex-column">
                        <div class="featured-text text-center">
            ...
            <div class="carousel-item" data-bs-interval="5000">
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center m-4">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <img class="img-fluid-border mb-3 mb-lg-0"
                            src="{{ asset ('public/assets/img/webs/KreatorMenu.png') }}" alt="Quizow" />
                    </div>
                    <div class="col-xl-5 col-lg-5 d-flex flex-column">
                        <div class="featured-text text-center">
                        ...
                        <div class="text-center mt-4 margines">
                            <a href="{{ asset('public/assets/downloads/Kreator_Menu.html') }}" class="btn btn-primary" download>Pobierz</a>
                        </div>
                    </div>
                    <div class="col-xl-1 col-lg-1"></div>
                </div>
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center m-4">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <img class="rotate img-fluid-border mb-3 mb-lg-0"
                            src="{{ asset ('public/assets/img/apps/NoPhoto.png') }}" alt="NoPhoto" />
                    </div>
                    <div class="col-xl-5 col-lg-5 d-flex flex-column">
                        <div class="featured-text text-center">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center m-4">
                    ...
                    <div class="col-xl-5 col-lg-5 d-flex flex-column">
                        ...
                        <div class="text-center mt-4 margines">
                            ...
                            <!-- Miniatury obrazków -->
                            <img src="{{ asset('public/assets/img/graphics/Onelife/1L.webp') }}" alt="OneLife Logo Main"
                                class="img-fluid" style="width: auto; height: 5rem; cursor: pointer;"
                                data-bs-toggle="modal" data-bs-target="#modal1L">

                            <img src="{{ asset('public/assets/img/graphics/Onelife/1Lmain.webp') }}" alt="OneLife Logo"
                                class="img-fluid" style="width: auto; height: 5rem; cursor: pointer;"
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-6">
                                <img class="img-graphic-border mb-3 mb-lg-0"
                                    src="{{ asset('public/assets/img/graphics/NocSwietojanska/NocSwietojanska.png') }}"
                                    alt="NocSwietojanska" data-bs-toggle="modal" data-bs-target="#Plakat1" />
                            </div>
                            <div class="col-xl-6 col-lg-6 col-6">
                                <img class="img-graphic-border mb-3 mb-lg-0"
                                    src="{{ asset('public/assets/img/graphics/NocSwietojanska/NocSwietojanskaV2.png') }}"
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center m-4">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-6">
                                <img class="img-graphic-border mb-3 mb-lg-0"
                                    src="{{ asset('public/assets/img/graphics/ReklamaLatowicz/UlotkaLatowicz1.png') }}"
                                    alt="UlotkaLatowicz" data-bs-toggle="modal" data-bs-target="#Ulotka1" />
                            </div>
                            <div class="col-xl-6 col-lg-6 col-6">
                                <img class="img-graphic-border mb-3 mb-lg-0"
                                    src="{{ asset('public/assets/img/graphics/ReklamaLatowicz/UlotkaLatowicz2.png') }}"
            ...
            <div class="carousel-item" data-bs-interval="5000">
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center m-4">
                    ...
                    <div class="col-xl-5 col-lg-5">
                        <!-- Klikalne zdjęcie -->
                        <img class="img-fluid-border mb-3 mb-lg-0"
                            src="{{ asset('public/assets/img/graphics/ReklamaLatowicz/BanerLatowicz.png') }}"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-dark border-0">
                        ...
                        <div class="modal-body text-center">
                            <img src="{{ asset('public/assets/img/graphics/Onelife/1L.webp') }}" class="img-fluid"
            ...
            <div class="modal fade" id="modal1Lmain" tabindex="-1" aria-labelledby="modal1LmainLabel"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-dark border-0">
                        ...
                        <div class="modal-body text-center">
                            <img src="{{ asset('public/assets/img/graphics/Onelife/1Lmain.webp') }}" class="img-fluid"
                                alt="OneLife Logo">
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="Plakat1" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-dark border-0">
                        ...
                        <div class="modal-body text-center">
                            <img src="{{ asset('public/assets/img/graphics/NocSwietojanska/NocSwietojanska.png') }}"
            ...
            <div class="modal fade" id="Plakat2" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-dark border-0">
                        ...
                        <div class="modal-body text-center">
                            <img src="{{ asset('public/assets/img/graphics/NocSwietojanska/NocSwietojanskaV2.png') }}"
                                class="img-fluid" alt="NocSwietojanska" />
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="Ulotka1" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-dark border-0">
                        ...
                        <div class="modal-body text-center">
                            <img src="{{ asset('public/assets/img/graphics/ReklamaLatowicz/UlotkaLatowicz1.png') }}"
            ...
            <div class="modal fade" id="Ulotka2" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-dark border-0">
                        ...
                        <div class="modal-body text-center">
                            <img src="{{ asset('public/assets/img/graphics/ReklamaLatowicz/UlotkaLatowicz2.png') }}"
                                class="img-fluid" alt="UlotkaLatowicz" />
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="BanerLatowicz" tabindex="-1" aria-labelledby="imageModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content bg-dark border-0">
                        ...
                        <div class="modal-body text-center">
                            <img src="{{ asset('public/assets/img/graphics/ReklamaLatowicz/BanerLatowicz.png') }}"
    ...
    <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
        ...
        <div class="col-lg-6"><img class="img-fluid" src="{{ asset ('public/assets/img/ipad.png') }}" alt="..." /></div>
        <div class="col-lg-6">
