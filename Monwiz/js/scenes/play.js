...
var playScene = {
  ...
  extend: {
    ...
    addFlower(type) {
      ...
      var newFlower;
      do {
        var x = Phaser.Math.Between(16, 1872);
        var y = Phaser.Math.Between(24, 1544);
        console.log("x: ", x, "\ny: ",y)
      } while (((x >= 1456 && x <= 1808) && (y >= 360 && y <= 632)) && ((x >= 0 && x <= 272) && (y >= 1448 && y <= 1568)));

      switch (type) {
        case "rose":
          newFlower = this.rosesGroup.create(x, y, "rose").setDepth(0);
          break;
        case "cornflower":
          newFlower = this.cornflowersGroup.create(x, y, "cornflower").setDepth(0);
          break;
        case "malwa":
          newFlower = this.malwasGroup.create(x, y,"malwa").setDepth(0);
          break;
        default:
          break;
      }
    ...
    map() {
      ...
      let layer2 = demo.createLayer("przod", [terrain], 0, 0).setDepth(1);
      let layer3 = demo.createLayer("dodatki", [terrain], 0, 0).setDepth(2);
      ...
      robber_1.forEach((robber_1) => {
        if (
          ...
          robber_1.hp > 0
            ...
            robber_1.hp = this.attack(playerDmg, robber_1.hp);
          console.log("Gracz atakuje");
          console.log("HP Malzahar:", robber_1.hp);
        }
      });

      robber_2.forEach((robber_2) => {
        if (
            robber_2 &&
          Phaser.Math.Distance.Between(
            robber_2.x,
          ...
          robber_2.hp > 0
            ...
            robber_2.hp = this.attack(playerDmg, robber_2.hp);
          console.log("Gracz atakuje");
          console.log("HP Izy:", robber_2.hp);
        }
      });

      robber_boss.forEach((robber_boss) => {
        if (
            robber_boss &&
          Phaser.Math.Distance.Between(
            robber_boss.x,
          ...
          robber_boss.hp > 0
            ...
            robber_boss.hp = this.attack(playerDmg, robber_boss.hp);
          console.log("Gracz atakuje");
          console.log("HP slime:", robber_boss.hp);
        }
      });
