...
getRouter()->addRoute('contactShow',    'ContactCtrl');									//główna ścieżka/akcja strony Play Hunt
getRouter()->addRoute('contact',    	'ContactCtrl');									//główna ścieżka podstrony Kontakt
